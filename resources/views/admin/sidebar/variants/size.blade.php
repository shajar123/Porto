...
@section('body')
    ...
    <div class="page-content">
        <div class="container-fluid">
            <div class="page-title-box d-flex justify-content-between">
                ...
                <h2> Size</h2>
                <div><a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addSizeModal"
                ...
                <div class="card-body py-3">
                    <div class="table-responsive">
                        <table class="table table-bordered text-nowrap" id="example2">
                            ...
                            <tbody>
                                @foreach ($size as $sizez)
                                <tr>
                                    <td>{{ $sizez->name ?? '' }}</td>

                                    <td>
                                        <button
                                            onclick="setValues('{{ $sizez->id }}','{{ $sizez->name }}')"
                                            data-toggle="modal" data-target="#editSizeModal" type="button"
                                            class="btn btn-success"><i class="fa fa-edit"></i></button>
                                        <button onclick="deleteCategory('{{ $sizez->id }}',$(this))" type="button"
    ...
    <!--/div-->
    <div class="modal fade" id="addSizeModal" tabindex="-1" role="dialog" aria-bs-labelledby="exampleModalLabel"
        aria-hidden="true">
    ...
    <div class="modal fade" id="editSizeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">

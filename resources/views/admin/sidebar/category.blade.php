            ...
            <div class="modal-content">
                ...
                <form id="addCategoryForm">
                    ...
                    <div class="modal-body">
                        ...
                        <input id="edit_sale_price" type="text" name="sale_price" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for=""><b>price</b></label>
                        <input id="edit_price" type="text" name="price" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for=""><b>Image</b></label>
                            <br>
                            <img style="height: 100px;
  width: 200px;object-fit: cover" id="categoryImagePreview" src="https://via.placeholder.com/1000x1000"
                                 onclick="$(this).next().click()" alt="">

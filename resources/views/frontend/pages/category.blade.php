                        ...
                        <div class="row">
                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default">
                                    <figure>
                                        <a href="product.html">
                                            <img style="width:300px; height:300px " src="{{asset($category->image)}}" width="280" height="280" alt="product" />
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title"> <a href="product.html">{{ $category->title }}</a> </h3>
                                        ...
                                        <div class="product-action">
                                            ...
                                            <a href="{{ route('products',$category->id) }}" class="btn-icon btn-add-cart"><i
